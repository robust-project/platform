...
/**
 * coauthorid is just a row id. All the authors of a given article are in articleid field.
 */
class Coauthor(val coauthorid: Long, val articleid: Long, val authorid: Long, val rank: Long)
