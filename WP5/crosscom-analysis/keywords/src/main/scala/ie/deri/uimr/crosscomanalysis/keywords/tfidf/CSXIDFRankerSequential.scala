...
object CSXIDFRankerSequential extends SequentialKeywordRanker with SessionFactorySetter with Logging with DBArgsParser {

  override val COMMAND_NAME = "rank-csxkeywords-seq"
