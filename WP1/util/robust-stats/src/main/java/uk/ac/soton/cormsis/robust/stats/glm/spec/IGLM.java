...
public interface IGLM extends ILM {
    ...
    /**
     * Return the distribution name if one has been entered.  Will be deleted late
     * @return The name of the link
     */
    public String getDistName();

    /**
     * Performing a fit using the initialized data 
     * @param LinkName Name of the link function
     */
    public double[] fit(String LinkName);

    /**
     * The fit automatically adds a column of one at the left hand side of the design matrix
     * Fitting the GLM of Ax=b under the specified link function
     * @param A design matrix
     * @param b response matrix
     * @param LinkName Name of the link function 
     * @return beta values
     */
    public double[] fit(double[][] A, double[] b, String LinkName);
