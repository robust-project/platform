...
-- -----------------------------------------------------
-- Table `robustwp1`.`datasource`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `robustwp1`.`datasource` ;

CREATE  TABLE IF NOT EXISTS `robustwp1`.`datasource` (
  `iddatasource` INT NOT NULL AUTO_INCREMENT ,
  `ds_name` VARCHAR(250) NULL ,
  `ds_uuid` VARCHAR(150) NULL ,
  `ds_endpoint` VARCHAR(250) NULL ,
  PRIMARY KEY (`iddatasource`) ,
  UNIQUE INDEX `ds_uuid_UNIQUE` (`ds_uuid` ASC) ,
  UNIQUE INDEX `ds_endpoint_UNIQUE` (`ds_endpoint` ASC) ,
  UNIQUE INDEX `ds_name_UNIQUE` (`ds_name` ASC) )
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `robustwp1`.`datalocation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `robustwp1`.`datalocation` ;

CREATE  TABLE IF NOT EXISTS `robustwp1`.`datalocation` (
  `iddatalocation` INT NOT NULL AUTO_INCREMENT ,
  `dl_type` VARCHAR(45) NULL ,
  `dl_dbhost` VARCHAR(250) NULL ,
  `dl_dbtype` VARCHAR(45) NULL ,
  `dl_dbport` VARCHAR(45) NULL ,
  `dl_dbname` VARCHAR(250) NULL ,
  `dl_streamuri` VARCHAR(250) NULL ,
  `dl_streamname` VARCHAR(150) NULL ,
  `datasource_iddatasource` INT NULL ,
  `datalocationcol` VARCHAR(45) NULL ,
  PRIMARY KEY (`iddatalocation`) ,
  INDEX `fk_datalocation_datasource1_idx` (`datasource_iddatasource` ASC) ,
  CONSTRAINT `fk_datalocation_datasource1`
    FOREIGN KEY (`datasource_iddatasource` )
    REFERENCES `robustwp1`.`datasource` (`iddatasource` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `robustwp1`.`community` (
  ...
  `datalocation_iddatalocation` INT NOT NULL ,
  `com_platform` VARCHAR(250) NULL ,
  PRIMARY KEY (`idcommunity`) ,
  UNIQUE INDEX `name_UNIQUE` (`com_name` ASC) ,
  UNIQUE INDEX `uuid_UNIQUE` (`com_uuid` ASC) ,
  INDEX `fk_community_datalocation1_idx` (`datalocation_iddatalocation` ASC) ,
  CONSTRAINT `fk_community_datalocation1`
    FOREIGN KEY (`datalocation_iddatalocation` )
    REFERENCES `robustwp1`.`datalocation` (`iddatalocation` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
