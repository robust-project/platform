...
public abstract class VizRelationBase implements IRelation
{
  protected String               relationLabel;
  protected IVizGraphic          vizGraphic;
  protected IDataObject          assigner;
  protected HashSet<IDataObject> assignees;
  
  // Protected methods ---------------------------------------------------------
  protected VizRelationBase( String label )
  {
    assignees = new HashSet<IDataObject>();
  }
}