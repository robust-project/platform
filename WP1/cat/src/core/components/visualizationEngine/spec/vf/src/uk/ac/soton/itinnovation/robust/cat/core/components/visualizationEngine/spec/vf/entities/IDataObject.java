...
{     
  ...
  Collection<IRelation> getCopyOfInRelations();
  
  Collection<IRelation> getCopyOfOutRelations();
  
  void addInRelation( IRelation relation ) throws VizException;
  
  void addOutRelation( IRelation relation ) throws VizException;
