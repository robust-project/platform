...
class DashIndicatorContainer extends SimpleView
{
  ...
  public static String DASH_LEFT_NAV_DESC = "Previous visualization";
  public static String DASH_RIGHT_NAV_DESC = "Next visualization";
  
  private AbstractDashIndicatorView targetView;
  ...
  protected void addIndicatorView( AbstractDashIndicatorView view )
  {
    if ( view != null )
    {
      ...
      currentVizButton = new LizButton( view.getIndicatorIcon(), view.getDescription() );
  ...
  private void createComonents()
  {
    ...
    button.setDescription(DASH_LEFT_NAV_DESC);
    ...
    button.setDescription(DASH_RIGHT_NAV_DESC);
  ...
  private void setIndicatorView( LizButton button )
  {
    if ( button != null )
    {
      targetView = attachedViews.get( button );
  ...
  public void refreshTargetView() {
      refreshTargetView(false);
  }
  
  public void refreshTargetView(boolean resizing) {
      if ( targetView != null )
        targetView.refreshView(resizing);
  }
  ...
  private class LizButton implements ClickListener
  {
    ...
    public LizButton( ThemeResource icon, String desc )
    {
