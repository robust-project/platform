                                            ...
                                            IDashboardController
{
  ...
  public DashboardController( ICATAppViewNavListener navListener, Properties props )
  {
    this.props = props;
  ...
  private void createComponents()
  {
    ...
    roMatrixController        = new ROMatrixController(navListener);
    ...
    gfxLizerController.getIndicatorView().setProperties(props); // first, set generic properties for GE
    dic.addIndicatorView( gfxLizerController.getIndicatorView() ); // then add the view
