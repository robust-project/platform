...
/**
 * An interface for a simulation job manager, defining the general API interactions
 * that need to be implemented.
 * @author Vegard Engen
 */
public interface ISimulationJobManager
{
    /**
     ...
     */
    JobDetails createNewJob(SimulationServiceJobConfig jobConfig);
    ...
    /**
     * Get the (latest) simulation result for a specific job.
     * @param jobRef The job reference.
     * @return
     * @throws Exception 
     */
    SimulationResult getResult(String jobRef) throws Exception;
}
