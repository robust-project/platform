...
import uk.ac.soton.itinnovation.robust.ps.impl.eval.ExampleEvaluator;
...
public class PredictorJobManager implements IPredictorJobManager
{
    ...
    private void getConfigs()
    {
        ...
        try {
            ...
            log.error("Error getting and parsing 'maxRunningNonStreamingJobs' parameter from service.properties. " + ex.getMessage(), ex);
            return;
        }
