...
public interface IPredictorService
{
     ...
     *         JobStatus object. The status SHOULD be one of: READY, FAILED or ERROR. 
    ...
    /**
     * Returns a JobStatus object, specifying the status according to the options 
     * depicted in Figure 22 on page 42. If ERROR or FAILED, please include a 
