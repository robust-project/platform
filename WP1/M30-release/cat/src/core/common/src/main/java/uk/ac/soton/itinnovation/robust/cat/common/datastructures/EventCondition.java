 ...
 * @author Vegard Engen
 */
public class EventCondition extends AParameter
{
    ...
    public boolean equals(Object obj) {
        ...
        if (this.type != other.type) {
            System.out.println("event conditions types are not equal");
            return false;
        }
        if ((this.name == null) ? (other.name != null) : !this.name.equals(other.name)) {
            System.out.println("event conditions names are not equal ");
            return false;
        }
        if (this.preConditionValue != other.preConditionValue && (this.preConditionValue == null || !this.preConditionValue.equals(other.preConditionValue))) {
            System.out.println("event conditions precondition are not equal value: "+ this.preConditionValue.getValue()+" : "+other.preConditionValue.getValue());
            return false;
        }
        if (this.postConditionValue != other.postConditionValue && (this.postConditionValue == null || !this.postConditionValue.equals(other.postConditionValue))) {
            System.out.println("event conditions postcondition are not equal");
            return false;
        }
        return true;
    }
