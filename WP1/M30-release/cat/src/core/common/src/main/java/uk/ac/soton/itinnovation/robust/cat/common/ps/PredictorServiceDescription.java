...
public class PredictorServiceDescription
{
    ...
    public boolean equals(Object obj) {
        ...
        if (this.serviceURI != other.serviceURI && (this.serviceURI == null || !this.serviceURI.equals(other.serviceURI))) {
            System.out.println("service uris are not equal "+this.serviceURI +" != "+other.serviceURI);
            return false;
        }
        if ((this.serviceTargetNamespace == null) ? (other.serviceTargetNamespace != null) : !this.serviceTargetNamespace.equals(other.serviceTargetNamespace)) {
            System.out.println("serviceTargetNamespace  are not equal "+this.serviceTargetNamespace +" != "+other.serviceTargetNamespace);
            return false;
        }
        if ((this.serviceName == null) ? (other.serviceName != null) : !this.serviceName.equals(other.serviceName)) {
            System.out.println("serviceName  are not equal "+this.serviceName +" != "+other.serviceName);
            return false;
        }
        if ((this.servicePortName == null) ? (other.servicePortName != null) : !this.servicePortName.equals(other.servicePortName)) {
            System.out.println("servicePortName  are not equal "+this.servicePortName +" != "+other.servicePortName);
            return false;
        }
        return true;
    }
