...
public class TreatmentViewCD extends UIChangeData
{
  private HashMap<Float, TreatmentTemplate> templates;
  
  
  public TreatmentViewCD()
  { 
    super();
    
    templates = new HashMap<Float, TreatmentTemplate>();
  }
  
  public void addTreatmentTemplate( TreatmentTemplate tt, Float order )
  {
    if ( tt != null && order != null )
    {
      templates.put( order, tt);
      dataChanged = true;
    }
  }
  
  public HashMap<Float, TreatmentTemplate> getTemplates()
  { return templates; }
