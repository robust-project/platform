...
/*
 * For internal use only - not be made available via the ViewEngine
 */
public interface WelcomeViewListener
{
  ...
  /**
   * The welcome view requires an updated list of currently available
   * communities to present to the user.
   */
