...
public class RiskEditBrowseView extends SimpleView
{
  ...
  private void createComponents()
  {
    ...
    button.addListener( new SaveClickListener() );
    ...
    button = new Button( "Discard changes" );
    button.setImmediate( true );
    button.addListener( new DiscardClickListener() );
    hl.addComponent( button );
    hl.setComponentAlignment( button, Alignment.MIDDLE_CENTER );
  ...
  {
    String newTitle = (String) roTitleField.getValue();
