...
public class CATSimIntegrationEngine
{
  ...
  public enum eIntegratedSimulation { eKoblenzForumRestriction };
  
  
  public static ISimulationController getSimulation( IUFView parent, eIntegratedSimulation sim )
  {
