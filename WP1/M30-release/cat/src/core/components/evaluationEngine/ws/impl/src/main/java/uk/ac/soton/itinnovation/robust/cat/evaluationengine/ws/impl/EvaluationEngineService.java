...
public class EvaluationEngineService implements IEvaluationEngineService, Lifecycle
{
    ...
    public void newEvaluationResult(String jobRef, EvaluationResult evalRes)
    {
        ...
        if (!initialised) {
            log.error("The evaluation engine service has not been initialised, so cannot deal with the new evaluation result");
        }
        ...
        this.evalEng.newEvaluationResult(jobRef, evalRes);
    }
    ...
    public void updateEvaluationJobStatus(String jobRef, JobStatus jobStatus)
    {
        ...
        if (!initialised) {
            log.error("The evaluation engine service has not been initialised, so cannot deal with the job status update");
        }
        ...
        this.evalEng.updateEvaluationJobStatus(jobRef, jobStatus);
    }
