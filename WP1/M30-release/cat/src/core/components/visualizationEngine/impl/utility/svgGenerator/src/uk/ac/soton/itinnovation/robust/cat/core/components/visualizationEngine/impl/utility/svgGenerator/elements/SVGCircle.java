...
import uk.ac.soton.itinnovation.robust.cat.core.components.visualizationEngine.spec.utility.svgGenerator.elements.ISVGCircle;
import uk.ac.soton.itinnovation.robust.cat.core.components.visualizationEngine.impl.utility.svgGenerator.*;




public class SVGCircle extends SVGVector implements ISVGCircle
{
  private float circRadius;
  
  public SVGCircle( SVGElGroup parent )
  {
    super ( parent );
  }
