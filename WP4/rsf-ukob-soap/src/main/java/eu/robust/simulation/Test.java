...
public class Test {
	...
	private static void createNewSimulationRun() {
		  ...
		  // this defines the type of simulation that is to be executed
		  // these types are predefined and hard coded
		  String communityModel = "MIMListOrdersE";
		  ...
		  String simId  =  robustService.startSimulation(parSet);
		  System.out.println("simID:" +simId);
	}
	
	
	private static void checkForSimulationFinish() {
	 ...
	 * you get a precomputed simulation result
	 */
