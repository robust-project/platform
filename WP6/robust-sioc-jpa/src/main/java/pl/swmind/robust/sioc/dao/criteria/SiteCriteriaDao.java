...
import pl.swmind.robust.sioc.dao.SiteDao;
import pl.swmind.robust.sioc.model.Site;
 ...
 */
@Component
public class SiteCriteriaDao extends CriteriaDao<Site> implements SiteDao {
    public SiteCriteriaDao(){
        super(Site.class);
    }
    protected SiteCriteriaDao(Class<Site> clazz) {
        super(clazz);
    }
}
