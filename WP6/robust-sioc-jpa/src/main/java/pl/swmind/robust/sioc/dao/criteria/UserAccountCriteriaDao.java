 ...
 */
@Component
public class UserAccountCriteriaDao extends CriteriaDao<UserAccount> implements UserAccountDao{
    public UserAccountCriteriaDao(){
        super(UserAccount.class);
    }
    protected UserAccountCriteriaDao(Class<UserAccount> clazz) {
        super(clazz);
    }
