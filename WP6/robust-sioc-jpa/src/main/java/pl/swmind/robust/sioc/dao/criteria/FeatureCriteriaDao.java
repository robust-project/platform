...
import pl.swmind.robust.sioc.dao.FeatureDao;
 ...
 */
@Component
public class FeatureCriteriaDao extends CriteriaDao<Feature> implements FeatureDao{
    public FeatureCriteriaDao(){
        super(Feature.class);
    }

    protected FeatureCriteriaDao(Class<Feature> clazz) {
        super(clazz);
    }
}
