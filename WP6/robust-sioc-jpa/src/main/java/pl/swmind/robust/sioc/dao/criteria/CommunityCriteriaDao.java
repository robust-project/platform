...
import pl.swmind.robust.sioc.dao.CommunityDao;
 ...
 */
@Component
public class CommunityCriteriaDao extends CriteriaDao<Community> implements CommunityDao{
    public CommunityCriteriaDao(){
        super(Community.class);
    }

    protected CommunityCriteriaDao(Class<Community> clazz) {
        super(clazz);
    }
}
